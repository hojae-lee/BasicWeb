...
<%-- JSP 주석 : 소스보기를 해도 화면에 출력되지 않는다. --%>
<%-- include 페이지 지시어 : 공통으로 사용할 jsp파일을 생성한 후 현재문서에 포함시킬떄사용한다. --%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<link rel="stylesheet" href="./style/div_layout.css" />
</head>
<body>
...
<div class="AllWrap">
   ...
   <div class="body">
      ...
      <!-- Contents 영역-->
      	 ...
      	 <br /><br />
         <h2>백악관 "6·12 회담 개최 준비…회담 미뤄져도 준비돼있어"(종합)</h2>
